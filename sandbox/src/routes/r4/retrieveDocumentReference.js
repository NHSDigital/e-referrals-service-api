...
function retrieveDocumentReference(request, h) {
    ...
    if(request.method == 'HEAD') {
        ...
        var responsePath = mockResponseProvider.getExampleResponseForGetDocumentReference(request)
        if (responsePath) {
...
module.exports = [
    {
        method: 'GET',
        path: '/FHIR/R4/DocumentReference/{uuid}',
        handler: retrieveDocumentReference
    }
]
