...
function retrieveQuestionnaireResponse(request, h) {
    ...
    if(request.method == 'HEAD') {
        ...
        var responsePath = mockResponseProvider.getExampleResponseForGetQuestionnaireResponse(request)
        if (responsePath) {
...
module.exports = [
    {
        method: 'GET',
        path: '/FHIR/R4/QuestionnaireResponse/{uuid}',
        handler: retrieveQuestionnaireResponse
    }
]
