...
function retrieveServiceRequest(request, h) {
    ...
    if(request.method == 'HEAD') {
        ...
        var responsePath = mockResponseProvider.getExampleResponseForGetServiceRequest(request)
        if (responsePath) {
...
module.exports = [
    {
        method: 'GET',
        path: '/FHIR/R4/ServiceRequest/{uuid}',
        handler: retrieveServiceRequest
    }
]
