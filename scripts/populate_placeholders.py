...
def main():
    ...
    substitutes_dict = {
      ...
      "[[HYPERLINK_A010]]": "[A010 - Patient service search](#api-Default-a010PatientServiceSearch)",
      "[[HYPERLINK_A011]]": "[A011 - Create referral](#api-Default-a011CreateReferral)",
      "[[HYPERLINK_A012]]": "[A012 - Maintain referral letter](https://developer.nhs.uk/apis/e-Referrals/explore_endpoint_a012.html)",
      "[[HYPERLINK_A015]]": "[A015 - Retrieve appointment slots](#api-Default-a015RetrieveAppointmentSlots)",
      "[[HYPERLINK_A016]]": "[A016 - Book or defer appointment](https://developer.nhs.uk/apis/e-Referrals/explore_endpoint_a016.html)",
      "[[HYPERLINK_A021]]": "[A021 - Create referral and send for triage](#api-Default-a021CreateReferralRequestAndSendForTriage)",
