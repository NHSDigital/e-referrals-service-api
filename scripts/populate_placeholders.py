...
def main():
    ...
    substitutes_dict = {
        ...
        "[[HYPERLINK_A028]]": "[A028 - Record triage outcome](#post-/STU3/ReferralRequest/-ubrn-/$ers.recordReviewOutcome)",
        ...
        "[[HYPERLINK_CIS_AUTH_SHRT]]": "[CIS2](https://digital.nhs.uk/services/identity-and-access-management/nhs-care-identity-service-2/care-identity-authentication)",
