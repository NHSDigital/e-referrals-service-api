...
def main():
    ...
    substitutes_dict = {
      ...
      "[[HYPERLINK_A008]]": "[A008 - Retrieve worklist](#api-Default-a008-retrieve-worklist)",
      ...
      "[[HYPERLINK_A023]]": "[A023 - Retrieve advice and guidance requests worklist](https://developer.nhs.uk/apis/e-Referrals/explore_endpoint_a023.html)",
