...
class TestAvailableActionsForUser(SandboxTest):
    ...
    testdata = [
        (
            ...
            "availableActionsForUserList/Empty.json",
        ),
        (
            {
            ...
            "availableActionsForUserList/WithRecordReviewOutcome.json",
        ),
        (
            {
            ...
            "availableActionsForUserList/WithCreateAppointment.json",
        ),
        (
            {
            ...
            "availableActionsForUserList/WithChangeShortlist.json",
        ),
        (
            {
            ...
            "availableActionsForUserList/WithChangeShortlistAndSendForTriage.json",
        ),
        (
            {
            ...
            "availableActionsForUserList/WithCancelReferral.json",
        ),
        (
            {
            ...
            "availableActionsForUserList/WithCancelDBAppointment.json",
        ),
    ]
